...
\subsection{New 100 Gbit/sec Hardware}
\begin{frame}{New 100 Gbit/sec Hardware, from 2024}
...
\begin{tabular}{cc}
	\begin{minipage}{.6\linewidth}
	    \includegraphics[height=0.8\textheight]{images/66vscur.pdf}
	\end{minipage}
    &
...
\subsection{Know Your Optimization Goal}
\begin{frame}{Know Your Optimization Goal}
    \includegraphics[width=\textwidth]{kstack/trex-http-simple.pdf}
\begin{itemize}
    \item Cisco TRex stateful http simple
    \item relayd(8) socket splicing
    \item 700 MBit per second throughput
\end{itemize}
\end{frame}
